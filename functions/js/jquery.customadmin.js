...
/*----------------------------------------------------------------------------------*/
	...
	var staOptions = jQuery('#my_meta_box_sta');
	var staTrigger = jQuery('#post-format-0');
	
	staOptions.css('display', 'none');
...
/*----------------------------------------------------------------------------------*/
	...
	var audioOptions = jQuery('#my_meta_box_audio');
...
/*----------------------------------------------------------------------------------*/
	...
	var videoOptions = jQuery('#my_meta_box_video');
...
/*----------------------------------------------------------------------------------*/
	...
	group.change( function() {
		...
		if(jQuery(this).val() == 'quote') {
			...
			staOptions.css('display', 'block');
			tzHideAll(staOptions);
