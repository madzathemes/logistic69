...
add_theme_page('Madza Import', esc_html__('Madza Import', 'madza'), 'manage_options', 'madza_options_import_page', array(&$this, 'madza_generate_import_page'));
	...
	function madza_generate_import_page() {
		...
		<div id="madza-metaboxes-general" class="wrap">
			<h2><?php _e('Madza - One Click Import Demo Content', 'madza') ?></h2>
					...
					<div id="post-body" class="has-sidebar">
						<div id="post-body-content" class="has-sidebar-content">
							<table class="form-table">
								...
								<tr valign="middle">
									...
									<td>
										<select name="import_example" id="import_example">
											<option value="madza1">Demo 1</option>
								...
								<tr class="loading-row"><td></td><td><div class="import_load"><span><?php _e('The import process may take <strong>2 minutes</strong>. Please be patient when see <strong>60%</strong>.', 'madza') ?> </span><br />
								...
								<tr><td></td><td><div class="success_msg" id="success_msg"><?php echo esc_html($this->message); ?></div></td></tr>
								</tbody>
							</table>
						</div>
					</div>
