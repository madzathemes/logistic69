  ...
  class OT_Cleanup {
    ...
    public function maybe_cleanup() {
      ...
      if ( $ot_maybe_cleanup_posts || $ot_maybe_cleanup_table ) {
        ...
        $theme_check_bs( apply_filters( 'ot_cleanup_page_title', esc_html__( 'OptionTree Cleanup', 'option-tree' ) ), apply_filters( 'ot_cleanup_menu_title', esc_html__( 'OptionTree Cleanup', 'option-tree' ) ), 'edit_theme_options', 'ot-cleanup', array( $this, 'options_page' ) );
